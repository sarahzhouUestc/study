class CONFIG(object):
    ...
    """
    input_size = 368
    heatmap_size = 46                   #卷积结果feature map的尺寸是46*46
    cpm_stages = 6
    hm_gaussian_variance = 1.0           #生成heatmap时的方差
    center_radius = 21
    cmap_radius = 40
    num_of_joints = 16
    color_channel = 'RGB'

    base_path = "/home/administrator/PengXiao/tensorflowtest/convolutional-pose-machines"
    image_dir = "/home/administrator/diskb/PengXiao/code/convolutional-pose-machines-release/dataset/MPI/images/"
    model_dir = "/home/administrator/diskb/PengXiao/code/convolutional-pose-machines-release/ckpt_models"
    middle_output = "/home/administrator/diskb/PengXiao/code/convolutional-pose-machines-release/middle"
    model_name = "cpm.ckpt"
